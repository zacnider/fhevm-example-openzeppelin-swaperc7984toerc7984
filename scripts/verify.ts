...
async function main() {
  ...
  console.log(`\n🔍 Verifying EntropySwapERC7984ToERC7984...`);
  ...
  try {
    await hre.run("verify:verify", {
      ...
      constructorArguments: [ENTROPY_ORACLE_ADDRESS, "0x0000000000000000000000000000000000000000", "0x0000000000000000000000000000000000000000"],
    });
    
    console.log(`\n✅ EntropySwapERC7984ToERC7984 verified successfully!`);
